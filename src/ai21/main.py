from src.ai21.ai21_client import AI21Client
...
def generate_completion_input():
    ...
    as_dict = to_dict(completion_params)
    return as_dict


def test_http_call(api_key: str):
    configs = ClientConfigs(num_retries=1)
    ai21_client = AI21Client(api_key, configs)

    response = ai21_client.completion(params=generate_completion_input())
    print(response)
